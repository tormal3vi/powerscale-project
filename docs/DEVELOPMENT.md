# Powerscale — development log

> This is the project's build log: how each part was designed, the
> problems found along the way and why things work the way they do,
> written phase by phase as they happened. Early sections describe the
> project as it was at that point (e.g. the Streamlit prototype); later
> phases supersede them. For what the site is today, see the
> [README](../README.md).
...
DB at this stage - the "who would win" calculator came next (Phase 5,
below).
